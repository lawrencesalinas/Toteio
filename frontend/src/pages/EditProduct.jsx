...
function EditProduct() {
    ...
    const [formImage1, setFormImage1] = useState(product.image1)
    ...
    const onSubmit = (e) => {
        e.preventDefault()
        dispatch(editProduct({ title, condition, brand, price, description, category, image1, image2, image3, image4, gender, id }))
